...
VALUES
    ...
    ('D012DD012', 'Volkswagen', 'Golf', 2019, 'Alice', 'Johnson', 'Brown');
    ...
    ('I567II567', 'Mercedes-Benz', 'C-Class', 2015, 'Grace', 'Thomas', 'Jackson'),
    ('J890JJ890', 'Audi', 'A4', 2014, 'Henry', 'Jackson', 'White'),
    ('K123KK123', 'Porsche', 'Cayenne', 2013, 'Ivy', 'White', 'Harris');
    ('L456LL456', 'Mazda', 'CX5', 2012, 'Jack', 'Harris', 'Martin'),
    ('M789MM789', 'Ferrari', '488', 2011, 'Kate', 'Martin', 'Thompson'),
    ('N012NN012', 'Lamborghini', 'Aventador', 2010, 'Liam', 'Thompson', 'Garcia'),
    ('O345OO345', 'Bugatti', 'Chiron', 2009, 'Mia', 'Garcia', 'Martinez'),
    ('P678PP678', 'Dodge', 'Challenger', 2008, 'Natalie', 'Martinez', 'Roberts'),
    ('Q901QQ901', 'Jaguar', 'XJ', 2007, 'Olivia', 'Roberts', 'Lewis'),
    ('R234RR234', 'Tesla', 'Model S', 2006, 'Penelope', 'Lewis', 'Walker'),
    ('S567SS567', 'Porsche', '911', 2005, 'Quinn', 'Walker', 'Hernandez'),
    ('T890TT890', 'Ferrari', '488 GTB', 2004, 'Rachel', 'Hernandez', 'Lopez'),
    ('U123UU123', 'Lamborghini', 'Aventador SVJ', 2003, 'Samantha', 'Lopez', 'Perez'),
